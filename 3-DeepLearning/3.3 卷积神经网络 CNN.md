![Pasted image 20250502222212.png](../images/Pasted%20image%2020250502222212.png)
...
- 例子 🌰：
	...
	- 计算过程![Pasted image 20250504114907.png](../images/Pasted%20image%2020250504114907.png)
	- 输出：`3*3`特征图
 - 关键参数：
...
- 常见类型：
	- 最大池化 (Max Pooling)：取窗口内最大值 （保留显著特征）![Pasted image 20250502222547.png](../images/Pasted%20image%2020250502222547.png)
	- 平均池化 (Average Pooling)：取窗口内平均值 （平滑特征）  ![Pasted image 20250502222612.png](../images/Pasted%20image%2020250502222612.png)
- 超参数：
	- 池化窗口大小 (e.g., `2*2`)
	- 步长 (e.g., 2) 通常步长等于窗口大小
