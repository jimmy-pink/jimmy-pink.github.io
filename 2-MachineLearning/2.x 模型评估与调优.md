...
#####  **🔹 数据问题**
	包含不一致的标记、缺失值或错误的标签
#####  **🔹 过拟合与欠拟合**
![Pasted image 20260220193857.png](../images/Pasted%20image%2020260220193857.png)
- 过度拟合(Overfitting): 
...
- 欠拟合 Underfitting： 
	...
	- 表现：模型无法捕捉数据的复杂性
	- 成因：隐藏层神经元过少
![Pasted image 20260220194045.png](../images/Pasted%20image%2020260220194045.png)
...
![Pasted image 20260214210324.png](../images/Pasted%20image%2020260214210324.png)
