...
![Pasted image 20250418104208.png](../images/Pasted%20image%2020250418104208.png)
...
5. <font style="background-color: #FFFACD; color: #333333; padding: 4px; border-radius: 8px; text-shadow: 1px 1px 2px rgba(0,0,0,0.1); font-weight: bold;">模型训练与调优</font> Model Training & Tuning
	...
	- 操作：
		- 划分数据集： 训练集 Train、验证集 Validation、测试集 Test，70:15:15。
		- 训练模型
		- 超参数调优
...
<font style="background-color:lightgrey">浅层学习同样需要通过训练来学习数据中的模式，只是模型本身比深度学习模型简单得多，层数较少。</font>
