...
![Pasted image 20250417173036.png](../images/Pasted%20image%2020250417173036.png)
...
### 3. 模型验证方法 (Model Validation)

- 目的：在模型训练过程中，用来优化和调节模型的超参数，避免过度拟合。
