...
#### 回归 Regression
[[2.5 回归与分类#回归 (Regression|🔗 回归 (Regression)]]
...
-  [[2.5 回归与分类#简单线性回归 (Simple Linear Regression|简单线性回归 (Simple Linear Regression)]]： 简单数值预测
- [[2.5 回归与分类#普通最小二乘法回归（OLS）|普通最小二乘法回归（OLS）]]
- [[2.5 回归与分类#非线性回归 Nonlinear Regression|非线性回归 Nonlinear Regression]]
...
#### 分类问题 Classification
[[2.5 回归与分类#分类问题 (Classification)|🔗 分类问题 (Classification)]]

 根据输入数据预测**离散类别**

<font style="background-color:tomato; color:white; padding:4px; text-shadow: 1px 1px 2px rgba(0,0,0,0.2);font-weight: bold;">传统机器学习算法：</font>
	
- [[2.5 回归与分类#逻辑回归 (Logistic Regression)|🥏 逻辑回归 Logistic Regression]]   **二分类问题**， 如垃圾邮件标注，是猫还是狗
- [[2.5 回归与分类#🥏 决策树 Decision Tree|🥏 决策树 Decision Tree]]
- [[2.5 回归与分类#🥏 回归树 Regression Tree|🥏 回归树 Regression Tree]]
- [[2.5 回归与分类#🥏 支持向量机 SVM (Support Vector Machine)|🥏 支持向量机 SVM (Support Vector Machine) ]]
- [[2.5 回归与分类#🥏 K-最近邻居 KNN (K-Nearest Neighbors)|🥏 K-最近邻居 KNN (K-Nearest Neighbors)]]
- [[2.5 回归与分类#🥏 随机森林 (Random Forest)|🥏 随机森林 Random Forest]]
- [[2.5 回归与分类#🥏 极端梯度提升 (XGBoost)|🥏 极端梯度提升 XGBoost]]
